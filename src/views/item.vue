    ...
    <div id="main">
        ...
        <div class="store-content item">
            ...
            <div class="details item-box">
                <div v-for="img in itemInfo.img" :key="img">
                    <img :src="img.image">
                </div>
            </div>
            <!-- 插入视频 -->
            <video width="100%" height="100%" preload="auto" controls v-for="item in itemInfo.video" :key="item">
                <source :src="item.videoOptions"  type="video/mp4" >
                您的浏览器不支持 video 标签
            </video>
            <div class="item-box text" v-for="item in itemInfo.img" :key="item">
                <p>{{item.text1}}</p>
                <p>{{item.text2}}</p>
                <p>{{item.text3}}</p>
                <p>{{item.text4}}</p>
