        ...
        <div class="content page-order-payment">
            ...
            <div class="gray-box clear">
                ...
                <div class="box-inner payment-checkout-panel clear">
                    <span class="jianguo-blue-main-btn big-main-btn js-payment-order" @click="payNow(orderInfo.orderId)" v-if="!orderInfo.isPay">
                        <a>现在支付</a>
                    </span>
            ...
            <div class="confirm-detail">
                ...
                <p class="info-detail">姓名：{{orderInfo.receiverInfo.name}}</p>
                <p class="info-detail">联系电话：{{orderInfo.receiverInfo.phone}}</p>
                <p class="info-detail">详细地址：{{orderInfo.receiverInfo.province}}{{orderInfo.receiverInfo.city}}{{orderInfo.receiverInfo.county}}</p>
            </div>
            <div class="confirm-detail">
            ...
            <div class="confirm-goods-table">
                <div class="cart-items clear" v-for="(item,index) in orderInfo.goodsData" :key="(item,index)">
                    <div class="name fn-left hide-row">
                        <div class="name-cell">
                            <a href="#" :title="item.title+'（'+item.spec_json.show_name+'）'" target="_blank">
                                {{item.title}}（{{item.spec_json.show_name}}）</a><br>
                        </div>
                    </div>
