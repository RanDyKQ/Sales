        ...
        <div class="account-address">
            <div class="gray-box clear">
                <div class="title pre-title">
                    ...
                    <span class="gray-blue-btn js-add-address"><a class="add" @click="addReceive">添加新的收货地址</a></span>
                </div>
                <div class="box-inner clear">
                    <div v-if="receiveInfo.length">
                      <div class="address-list-item default-item" v-for="(receive,index) in receiveInfo" :key="(receive,index)">
                        ...
                        <div class="operation fn-right">
                            <div class="operation-cell">
                                ...
                                <span class="red-del-btn js-del-address" @click="delAddress(receive,index)"> <a>删除</a><em>删除</em> </span>
                            </div>
                        </div>
  ...
  export default {
    ...
    methods: {
      ...
      editReceive (data, index) {
        ...
        this.popShow = true
        console.log(this.oldReceive)
      },
      /* 删除地址 */
      delAddress (data) {
        this.$store.commit('delAddress', data)
        console.log(data)
      }
    }
  }
