            ...
            <div class="cart-box">
                ...
                <div class="cart-inner">
                    <div class="empty-label" v-if="count<=0">
                        <h3>您的购物车中还没有商品</h3>
                        <router-link class="link" to="/Home">现在选购</router-link>
                    </div>
                    <div v-else>
                        ...
                        <div class="cart-table">
                            <div class="cart-group">
                                <!-- 购物列表 -->
                                <div class="cart-top-items" v-for="(item,index) in carPanelData" :key="(item,index)">
                    ...
                    <div class="shipping">
                        <div class="shipping-box">
                            ...
                            <div class="shipping-total shipping-price">
                                <h4>应付总额：<span>￥</span><i >{{checkedPrice}}</i></h4>
                                <h5 class="shipping-tips">应付总额不含运费</h5>
                            </div>
                        </div>
                        <router-link tag="span" to="/Checkout" class="jianguo-blue-main-btn big-main-btn js-checkout" :class="{'disabled-btn':checkedCount<=0}"><a>现在结算</a></router-link>
                    </div>
                </div>
            </div>
        </div>
...
.cart-box .empty-label{
    height: 30px;
    padding: 385px 0 0 0;
    background: url(../assets/img/cart_box_empty.png) no-repeat center 50px;
    text-align: center;
}
