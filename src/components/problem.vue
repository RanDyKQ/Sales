                ...
                <div class="banner-list clearfix">
                    <ul class="banner-list clearfix">
                        ...
                        <li class="jishu">
                            ...
                            <ul class="sub-question clearfix">
                                <li><a href="#">强制重新启动</a></li>
                                <li><a href="">截屏功能</a></li>
                                <li><a href="">延长续航时间</a></li>
                                <li><a href="">定位导航</a></li>
                                <li><a href="">手机开机激活方法</a></li>
                            </ul>
                            <ul class="sub-question clearfix">
                                <li>
                                    <a href="#">支持耳机接口标准</a>
                        ...
                        <li class="shouhou">
                            ...
                            <ul class="sub-question clearfix">
                                <li><a href="#">手机产品</a></li>
                                <li><a href="">手机附件</a></li>
                                <li><a href="">耳机、手机自拍杆</a></li>
                                <li><a href="">合作厂商商品</a></li>
                                <li><a href="">三包权益</a></li>
                            </ul>
                            <ul class="sub-question clearfix">
                                <li><a href="#">意外碎屏保修服务</a></li>
                                <li><a href="">意外损坏保修服务</a></li>
                                <li><a href="">延长保修服务</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
